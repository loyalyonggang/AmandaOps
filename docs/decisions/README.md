...
| [0034](./0034-custom-mcp-data-sources.md) | 自定义 MCP 数据源做成注册表+映射配置，内置三家保持写死 | 2026-09-10 |
| [0035](./0035-artifacts-live-under-the-answer.md) | 产物卡片挂在回答下面；命令写出来的文件也要记 | 2026-09-10 |
